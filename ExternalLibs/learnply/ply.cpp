...
(char *)"invalid",
(char *)"int8", (char *)"int16", (char *)"int32",
(char *)"uint8", (char *)"uint16", (char *)"uint32", (char *)"float32", (char *)"float64",
};

char *old_type_names[] = {  /* old names of types for backward compatability */
(char *)"invalid",
(char *)"char", (char *)"short", (char *)"int", (char *)"uchar",
(char *)"ushort", (char *)"uint", (char *)"float", (char *)"double",
};
  ...
  for (j = 0; j < elem->nprops; j++) {
    ...
    *str_ptr = str;
      ...
      if (store_it) {
        ...
        //printf("Item check: %s, %d, %f\n", item, int_val, double_val);
      }
    }
